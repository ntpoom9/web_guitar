...
WebUI.click(findTestObject('Object Repository/Page_Document/i__fas fa-shopping-cart'))

WebUI.click(findTestObject('Object Repository/Page_All Products BG-STORE/input__idcheckbox'))
