...
WebUI.click(findTestObject('Object Repository/Page_All Products BG-STORE/img'))
...
WebUI.click(findTestObject('Object Repository/Page_All Products BG-STORE/div_'))

WebUI.click(findTestObject('Object Repository/Page_All Products BG-STORE/input_ YAMAHA F600_product'))

WebUI.click(findTestObject('Object Repository/Page_All Products BG-STORE/button__1'))
