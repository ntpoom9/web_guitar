...
WebUI.setText(findTestObject('Object Repository/Page_account BG-STORE/input_Forgot password_Tel'), '0812345678')

WebUI.setText(findTestObject('Object Repository/Page_account BG-STORE/textarea_Forgot password_Address'), 'ต.เลาขวัญ อ.เลาขวัย จ.กาญจนบุรี')
